...
static_files_in_filesystem = find_all_path_in_folder_recur(my_path, 'js')
static_files_in_filesystem += find_all_path_in_folder_recur(my_path, 'css')
static_files_in_filesystem += find_all_path_in_folder_recur(my_path, 'jsp')
